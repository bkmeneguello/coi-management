...
INSERT INTO PRODUTO_CUSTO(PRODUTO_ID, CUSTO, DATA_INICIO_VIGENCIA) SELECT ID, CUSTO, '2013-01-01' FROM PRODUTO;

ALTER TABLE PRODUTO DROP COLUMN CUSTO;

ALTER TABLE COMISSAO ADD COLUMN VALOR DECIMAL(8,2);
ALTER TABLE COMISSAO ADD COLUMN RESTANTE CHAR(1);
ALTER TABLE COMISSAO ADD CONSTRAINT COMISSAO_CHK_RESTANTE CHECK (RESTANTE IN ('S', 'N'));

ALTER TABLE CATEGORIA ADD COLUMN TIPO_COMISSAO VARCHAR(10);
UPDATE CATEGORIA SET TIPO_COMISSAO = 'PERCENTUAL';
ALTER TABLE CATEGORIA ADD CONSTRAINT CATEGORIA_CHK_TIPO_COMISSAO CHECK (TIPO_COMISSAO IN ('PERCENTUAL', 'VALOR'));
ALTER TABLE CATEGORIA ALTER COLUMN TIPO_COMISSAO SET NOT NULL;

ALTER TABLE PAGAMENTO ADD COLUMN DOCUMENTO VARCHAR(40);
