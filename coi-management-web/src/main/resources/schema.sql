...
CREATE TABLE LAUDO (
	...
	COLUNA_LOMBAR_T1 CHAR(1) DEFAULT 'S' NOT NULL,
	COLUNA_LOMBAR_T2 CHAR(1) DEFAULT 'S' NOT NULL,
	COLUNA_LOMBAR_T3 CHAR(1) DEFAULT 'S' NOT NULL,
	COLUNA_LOMBAR_T4 CHAR(1) DEFAULT 'S' NOT NULL,
