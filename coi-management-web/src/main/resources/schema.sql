...
ALTER TABLE COMISSAO ADD COLUMN PARTE VARCHAR(14);
UPDATE COMISSAO SET PARTE = DECODE(PARTE_ID, 1, 'CONSULTORIO', 2, 'MEDICO', 3, 'FISIOTERAPEUTA', 4, 'PACIENTE', 5, 'CLIENTE');
...
ALTER TABLE ENTRADA_PARTE ADD COLUMN PARTE VARCHAR(14);
UPDATE ENTRADA_PARTE SET PARTE = DECODE(PARTE_ID, 1, 'CONSULTORIO', 2, 'MEDICO', 3, 'FISIOTERAPEUTA', 4, 'PACIENTE', 5, 'CLIENTE');
