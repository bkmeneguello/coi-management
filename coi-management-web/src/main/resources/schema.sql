...
ALTER TABLE PESSOA ADD COLUMN PREFIXO CHAR(1);
UPDATE PESSOA SET PREFIXO = SUBSTRING(CODIGO, 1, 1), CODIGO = SUBSTRING(CODIGO, 3, 10) WHERE CODIGO LIKE '%-%';
UPDATE PESSOA SET PREFIXO = 'P' WHERE PREFIXO IS NULL;
ALTER TABLE PESSOA ALTER COLUMN PREFIXO SET NOT NULL;
ALTER TABLE PESSOA ALTER COLUMN CODIGO INTEGER;