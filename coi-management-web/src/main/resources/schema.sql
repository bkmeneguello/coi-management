...
ALTER TABLE PRODUTO ADD COLUMN ESTOCAVEL CHAR(1);
UPDATE PRODUTO SET ESTOCAVEL = 'N';
ALTER TABLE PRODUTO ALTER COLUMN ESTOCAVEL SET NOT NULL;
ALTER TABLE PRODUTO ADD CONSTRAINT PRODUTO_CHK_ESTOCAVEL CHECK (ESTOCAVEL IN('S', 'N'));
