...
CREATE TABLE ENTRADA (
	...
	CONSTRAINT ENTRADA_FK_CHEQUE FOREIGN KEY (CHEQUE_ID) REFERENCES CHEQUE(ID), --REMOVER
...
INSERT INTO ENTRADA_CHEQUE(ENTRADA_ID, CHEQUE_ID) SELECT ID, CHEQUE_ID FROM ENTRADA;
...
ALTER TABLE ENTRADA DROP CONSTRAINT ENTRADA_FK_CHEQUE;
ALTER TABLE ENTRADA DROP COLUMN MEDICO_ID;
ALTER TABLE ENTRADA DROP COLUMN FISIOTERAPEUTA_ID;
ALTER TABLE ENTRADA DROP COLUMN CHEQUE_ID;